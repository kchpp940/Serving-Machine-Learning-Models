...
def predict_single(data: CarPrediction) -> PredictionResponse:
...
def predict_batch(data: BatchPredictionRequest) -> BatchPredictionResponse:
    service = get_model_service()
...
def explain_prediction(data: CarPrediction) -> ExplainResponse:
    service = get_model_service()
...
def get_service_status() -> StatusResponse:
    service = get_model_service()
