...
| 变量名 | Schema 本地默认 | Docker/Heroku | Shell 脚本 | Vercel |
|--------|-----------------|---------------|------------|--------|
| `API_HOST` | `0.0.0.0` | 同左 | 同左 | 同左 |
| `API_PORT` | `8000` | 同左 | 同左 | 同左 |
| `MODEL_DIR` | `<auto-resolved>` | `/app/shared_models` | `$PROJECT_ROOT/shared_models` | `<auto-resolved>` |
...
| `DATA_DIR` | `<auto-resolved>` | `/app/Data` | `$PROJECT_ROOT/Data` | `<auto-resolved>` |
| `API_BASE_URL` | `http://localhost:8000` | `http://localhost:${API_PORT}` | `http://localhost:$API_PORT` | `http://localhost:8000` |
